...
-- Sample Users
INSERT INTO user (email, name, role, points, certifications)
VALUES
('alice@example.com', 'Alice Tan', 'helper', 50, '["CPR","First Aid"]'),
('bob@example.com', 'Bob Lim', 'helper', 20, NULL),
('carol@example.com', 'Carol Wong', 'admin', 0, NULL),
('mallory@example.com', 'Mallory Doe', 'helper', 0, NULL);
